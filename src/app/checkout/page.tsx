      ...
      <div className="card bg-base-100 shadow-2xl w-full max-w-lg">
        <div className="card-body items-center text-center">
          ...
          <div className="bg-base-400">
            <p>The course will be sent to your email</p>
            <span className="bg-base-200 p-1 underline-offset-4 underline ">
              {user?.emailAddresses[0].emailAddress}
            </span>
          </div>
          <div className="mt-6 space-y-2 text-base-content/70 text-sm">
            <p>
              📦 You can view your purchase in <strong>My Courses</strong> on
              the main page.
            </p>
            <p>
              📞 Our manager will call you within a few hours to confirm the
              order.
            </p>
