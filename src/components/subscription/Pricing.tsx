...
function Pricing() {
  return (
    <section className="flex flex-col items-center justify-center max-w-5xl mx-auto p-6">
      ...
      <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white max-w-[450px] p-6 rounded-lg mt-6 text-center shadow-lg transform transition-transform duration-300 hover:scale-105">
        <p className="text-lg font-medium">✨ Limited Time Offer! ✨</p>
        <strong className="block text-2xl font-bold mt-2">
          Choose Any Subscription Plan
        </strong>
        <p className="mt-2 text-sm">Get access within 7 days for free</p>
        <b className="mt-1 text-sm font-extrabold">
          Get access now and pay according to your selected plan next.
        </b>
      </div>
